...
const ImportantNote = () => (
  <div className="bg-yellow-500/10 border-l-4 border-yellow-400 p-4 rounded mb-8">
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-black to-gray-800 relative overflow-hidden">
      ...
      <div className="flex flex-col items-center justify-center min-h-[calc(100vh-200px)] p-8">
        ...
        >
              ...
              {tabs.map((tab, index) => (
                <motion.button
                  ...
                  className={`px-6 py-3 rounded-lg font-medium transition-all duration-300 ${
                    activeTab === tab.id
                      ? 'bg-gradient-to-r from-yellow-600 to-yellow-700 text-white border-2 border-yellow-500'
                      : 'bg-gray-800/50 text-gray-300 border-2 border-gray-700 hover:border-yellow-400 hover:text-yellow-400'
                  }`}
          ...
          <motion.div 
            className="bg-gradient-to-br from-gray-900/80 to-black/80 rounded-xl p-8 backdrop-blur-sm border-2 border-yellow-500/30 mb-8"
            initial={{ y: 30, opacity: 0 }}
            animate={{ y: 0, opacity: 1 }}
          ...
          >
            {activeTab === 'generales' ? (
              ...
              >
                ...
                <h3 className="text-2xl font-bold text-yellow-400 mb-4">Sección en construcción</h3>
