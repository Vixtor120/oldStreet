...
const Menu: React.FC<MenuProps> = ({ onNavigate, onOpenAuthModal }) => {
  return (
                ...
                >
                  <div className="relative z-10">
                    <div className="flex items-center mb-4">
                      ...
                      <h4 className="text-xl font-bold text-amber-400">Crear Cuenta</h4>
                    </div>
                    
                    <p className="text-gray-300 mb-6 leading-relaxed">
                      <span className="text-amber-400 font-semibold">Regístrate</span> en nuestra plataforma para acceder a los formularios. 
                      Incluye tu Discord ID para verificación automática.
                    </p>

                    <motion.button 
                      className="w-full bg-gradient-to-r from-amber-600 to-amber-700 text-black font-bold py-3 px-6 rounded-lg border-2 border-amber-500"
                      whileHover={{
                        scale: 1.05,
                        boxShadow: "0 0 20px rgba(245, 158, 11, 0.3)",
                      }}
                      whileTap={{ scale: 0.95 }}
                      onClick={() => onOpenAuthModal ? onOpenAuthModal('register') : onNavigate('whitelist')}
                    >
                      👤 Crear Cuenta
                    </motion.button>
                  </div>
                  ...
                  {/* Efecto de fondo */}
                  <motion.div 
                    className="absolute top-0 right-0 w-20 h-20 bg-amber-500/10 rounded-full"
          ...
          >
            ...
            >
              <p className="text-center text-gray-300 mb-6">
                ¿Ya completaste todos los pasos? ¡Explora todas nuestras opciones!
              </p>
              
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <motion.button
                  className="bg-gradient-to-r from-purple-600 to-purple-700 text-white font-bold py-4 px-8 rounded-lg shadow-lg border-2 border-purple-500 flex items-center justify-center gap-3"
                  whileHover={{
                    scale: 1.05,
                ...
                <motion.button
                  className="bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold py-4 px-8 rounded-lg shadow-lg border-2 border-blue-500 flex items-center justify-center gap-3"
                  whileHover={{
                    scale: 1.05,
